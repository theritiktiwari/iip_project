...
{ 
  //orange LED of direction 2 will turn ON
...
void direction_3_orange(void) { 
  //orange LED of direction 3 will turn ON 
  digitalWrite(red_1,HIGH); 
  digitalWrite(orange_1,LOW); 
  digitalWrite(green_1,LOW); 
  digitalWrite(red_2,HIGH); 
...
void direction_3_green(void) { 
  //green LED of direction 3 will turn ON 
  digitalWrite(red_1,HIGH); 
  digitalWrite(orange_1,LOW); 
  digitalWrite(green_1,LOW); 
  digitalWrite(red_2,HIGH); 
...
void direction_4_orange(void) { 
  //orange LED of direction 4 will turn ON 
  digitalWrite(red_1,HIGH); 
  digitalWrite(orange_1,LOW); 
  digitalWrite(green_1,LOW); 
  digitalWrite(red_2,HIGH); 
...
void direction_4_green(void) { 
  //green LED of direction 4 will turn ON 
  digitalWrite(red_1,HIGH); 
  digitalWrite(orange_1,LOW); 
  digitalWrite(green_1,LOW); 
  digitalWrite(red_2,HIGH); 
...
void direction_1_orange(void) { 
  //orange LED of direction 1 will turn ON 
  digitalWrite(red_1,LOW); 
